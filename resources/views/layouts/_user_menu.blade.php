@auth
    ...
    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
        ...
        <a class="nav-link"  href="#address-tab" role="tab"><i class="fa fa-hourglass-start"></i>Reviews</a>
        <a class="nav-link" href="#address-tab" role="tab"><i class="fa fa-envelope"></i>messages</a>
