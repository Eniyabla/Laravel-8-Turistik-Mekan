...
@endphp
<style>
    .menu-area{background: orangered}
    .dropdown-menu{padding:0;margin:0;border:0 solid transition!important;border:0 solid rgba(245,255,255,.75);border-radius:0;-webkit-box-shadow:none!important;box-shadow:none!important}
    ...
    /==========Sub Menu=v==========/
    .mainmenu .collapse ul > li:hover > a{background: orangered;}
    .mainmenu .collapse ul ul > li:hover > a, .navbar-default .navbar-nav .show .dropdown-menu > li > a:focus, .navbar-default .navbar-nav .show .dropdown-menu > li > a:hover{background: orangered;}
    .mainmenu .collapse ul ul ul > li:hover > a{background: orangered;}

    .mainmenu .collapse ul ul, .mainmenu .collapse ul ul.dropdown-menu{background :black;}
    .mainmenu .collapse ul ul ul, .mainmenu .collapse ul ul ul.dropdown-menu{background:#000}
    .mainmenu .collapse ul ul ul ul, .mainmenu .collapse ul ul ul ul.dropdown-menu{background:#000}
