    ...
    <div class="container">
        <div class="row justify-content-between align-items-center d-flex">
            <div class="col-lg-8 top-left">
                <h1 class="text-white mb-20">product Details</h1>
                <ul>
                    <li>
...
<!-- Start product Area -->
<div class="product-wrapper pt-100">
    <!-- Start product Area -->
    <section class="product-area">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="single-page-product"> <div class="top-wrapper">
                            <div class="row d-flex justify-content-between">
                                ...
                                >
                                    ...
                                    <div class="user-img">
                                        <img src="{{asset('storage/user/'.$product->user->image)}}" alt="{{$product->user->name}}"  width="50px"/>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bottom-wrapper">
                            <div class="row">
                                <div class="col-lg-4 single-b-wrap col-md-12">
                                    @guest
                                        <i class="fa fa-heart-o" aria-hidden="true"></i>{{$product->likedUsers->count()}} people like this
                                    @else
                                        <a href="#" onclick="document.getElementById('like-form-{{$product->id}}').submit();"> <i class="fa fa-heart" aria-hidden="true" style="color: {{Auth::user()->likedproducts()->where('product_id', $product->id)->count() > 0 ? 'red' : ''}}"></i></a>
                                        {{$product->likedUsers->count()}} people like this

                                        <form action="{{route('product.like',$product->id)}}" method="product" style="display: none" id="like-form-{{$product->id}}">
                                            @csrf
                                        </form>
                                    @endguest
                                </div>
                                <div class="col-lg-4 single-b-wrap col-md-12">
                                    <i class="fa fa-eye" aria-hidden="true"></i> {{$product->view_count}}
                                    views
                                </div>
                                <div class="col-lg-4 single-b-wrap col-md-12">
                                    <i class="fa fa-comment-o" aria-hidden="true"></i> {{$product->comments->count()}}
                                    comments
                                </div>
                                <div class="row mx-1">
                                                        ...
                                                        <div class="user justify-content-between d-flex">
                                                            ...
                                                            <div class="desc">
                                                                ...
                                                                <div class="row flex-row d-flex">
                                                                    <form action="{{route('reply.store',$comment->id)}}" method="product">
                                                                        @csrf
                                                                        <div class="col-lg-12">
                                  <textarea
                        ...
                        <section class="commentform-area pb-120 pt-80 mb-100">
                            @guest
                                <div class="container">
                                    <h4>Please Sign in to product comments - <a href="{{route('login')}}">Sing in</a> or <a href="{{route('register')}}">Register</a></h4>
                                </div>
                            @else
                                <div class="container">
                                    ...
                                    <div class="row flex-row d-flex">
                                        <div class="col-lg-12">
                                            <form action="{{route('comment.store', $product->id)}}" method="product">
                                                @csrf
                                                <textarea
                                                    class="form-control mb-10"
                                                    name="message"
...
@push('footer')
    <script type="text/javascript">
        ...
        let productTitle = encodeURI('{{$product->title}}');
        ...
        gplusBtn.setAttribute("href",`https://plus.google.com/share?url=${productUrl}`);
